...
author: TiD
comments: true
date: 2019-08-27 09:30:28+00:00
layout: post
link: https://www.tidnotes.ga/2019/08/wordpress%e4%b9%8bgutenberg%ef%bc%88%e5%8f%a4%e8%85%be%e5%a0%a1%ef%bc%89%e8%87%aa%e5%ae%9a%e4%b9%89%e5%9d%97%ef%bc%88%e4%b8%80%ef%bc%89.html
slug: wordpress%e4%b9%8bgutenberg%ef%bc%88%e5%8f%a4%e8%85%be%e5%a0%a1%ef%bc%89%e8%87%aa%e5%ae%9a%e4%b9%89%e5%9d%97%ef%bc%88%e4%b8%80%ef%bc%89
...
本文内容来自海拔科技： [https://www.haibakeji.com/archives/582.html](https://www.haibakeji.com/archives/582.html) ，详细介绍各个属性可阅读WordPress之Gutenberg（古腾堡）自定义块（一）。
...
目前相关的中文内容还是很少，需要了解更多内容可以参考官方介绍:
  ...
  * [Gutenberg官方网站](https://wordpress.org/gutenberg/)
  * [Gutenberg 开发API](https://wordpress.org/gutenberg/handbook/designers-developers/developers/block-api/)
  * [WordPress 官方图标](https://developer.wordpress.org/resource/dashicons/#businessman)  
...
## 效果截图
  ...
  * 
[![](https://www.haibakeji.com/wp-content/uploads/2019/04/2019040611465542.gif)](https://www.haibakeji.com/wp-content/uploads/2019/04/2019040611465542.gif)



  * 
[![](https://www.haibakeji.com/wp-content/uploads/2019/04/2019040611465519.gif)](https://www.haibakeji.com/wp-content/uploads/2019/04/2019040611465519.gif)
...
找到你主题的 function.php文件，在最下方添加以下代码：
    ...
    <code class="lan language-php">// 古腾堡编辑器扩展
    function duxq_block() {
...
按照我们上面引入的js文件，我们打开编辑这个文件。
    ...
    <code class="lan language-js">(function(blocks, editor, element, components, _) {
    ...
    })(window.wp.blocks, window.wp.editor, window.wp.element, window.wp.components, window._, );</code>
...
通过创建了自定义块，能实现加载不同的css **className** 了，那我们添加一些样式，就可以看到效果了！
    ...
    <code class="lan language-css">.duxq.anz button {
       margin: 10px;
       padding: .5em 1em;
       min-width: 33px;
       min-height: 33px;
...
_1、_[WordPress之Gutenberg（古腾堡）自定义块（二）](https://www.tidnotes.ga/?p=208)  
