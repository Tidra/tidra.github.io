...
<div class="code-copy" style="position: relative;">
  <pre class="line-numbers language-php"><code>// 古腾堡编辑器扩展
function duxq_block() {
...
<div class="code-copy" style="position: relative;">
  <pre class="line-numbers language-js"><code>(function(blocks, editor, element, components, _) {
...
<div class="code-copy" style="position: relative;">
  <pre class="line-numbers language-css"><code>.duxq.anz button {
   margin: 10px;
   padding: .5em 1em;
   min-width: 33px;
   min-height: 33px;
