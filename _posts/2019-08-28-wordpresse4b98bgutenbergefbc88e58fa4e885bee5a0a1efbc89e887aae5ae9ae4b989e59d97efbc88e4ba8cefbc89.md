...
permalink: '/2019/08/wordpress%e4%b9%8bgutenberg%ef%bc%88%e5%8f%a4%e8%85%be%e5%a0%a1%ef%bc%89%e8%87%aa%e5%ae%9a%e4%b9%89%e5%9d%97%ef%bc%88%e4%ba%8c%ef%bc%89.html'
categories:
  - WordPress使用技巧
tags:
  - Gutenberg（古腾堡）
...
本文内容主要根据 &nbsp;Gutenberg 开发API ，为上文《 <a href="https://www.tidnotes.ga/?p=163" target="_blank" rel="noopener noreferrer">WordPress之Gutenberg（古腾堡）自定义块（一）</a> 》中的js代码做解读，让大家更了解自定义的构建。
...
<p class="has-small-font-size h5c">
  <em><strong>WordPress Gutenberg其他相关自定义系列文章：</strong></em><br /><em>1、</em><a href="https://www.tidnotes.ga/?p=163">WordPress之Gutenberg（古腾堡）自定义块（一）</a><br /><em>2、</em><a href="https://www.tidnotes.ga/?p=214">WordPress之Gutenberg（古腾堡）自定义块扩展栏</a><br /><em>3、<a href="https://www.tidnotes.ga/?p=238">WordPress之Gutenberg（古腾堡）自定义块工具栏</a></em>
</p>