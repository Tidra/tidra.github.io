...
<div class="code-copy" style="position: relative;">
  <pre class="line-numbers language-php"><code>//古腾堡编辑器工具栏
...
<div class="code-copy" style="position: relative;">
  <pre class="line-numbers language-js"><code>( function( wp ) {
...
<div class="code-copy" style="position: relative;">
  <pre class="line-numbers language-js"><code>var MyCustomButton = function( props ) {
