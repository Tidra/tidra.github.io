...
#### 关于[GitHub Pages](https://help.github.com/cn/categories/github-pages-basics)和[Jekyll](http://jekyllcn.com/) {.h3c}
...
[Jekyll](http://jekyllcn.com/)官方提供了各种博客迁移的方法，也包括了WordPress，有兴趣的可以到官网查看。目前我只是利用GitHub作为一个备用网站，不太常用到 Jekyll ，也不安装Jekyll相关组件到电脑上，所以以下提供两种不用安装Jekyll等就可以使用的办法。
